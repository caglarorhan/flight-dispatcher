...
async function main(): Promise<void> {
  ...
  let preserved = { description: '', architectureRules: [] as string[], todos: [] as string[] };
  ...
  const generated = generate(profile, detected, answers);
  ...
  if (existingContent && flags.update) {
    ...
    log.success('Merged with existing file (preserved: About, Architecture Rules, TODOs)');
  } else {
